...
![ Заполнение сертификата ](image/4.png){#fig-004 width=70%}
...
ErrorLog logs/www.kmprosina.net-error_log
CustomLog logs/www.kmprosina.net-access_log common
SSLCertificateFile /etc/ssl/certs/www.kmprosina.net.crt
SSLCertificateKeyFile /etc/ssl/private/www.kmprosina.net.key
</VirtualHost>
</IfModule>
'''
...
![ Разрешение ](image/6.png){#fig-006 width=70%}
...
dnf -y install php
```
![ Установка php ](image/8.png){#fig-008 width=70%}
...
![ Коррекстирование прав доступа ](image/10.png){#fig-010 width=70%}
...
![ Перезапуск ](image/11.png){#fig-011 width=70%}
...
![ Копии ](image/12.png){#fig-012 width=70%}
